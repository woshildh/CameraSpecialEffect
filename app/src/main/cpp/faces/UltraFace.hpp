...
class UltraFace {
public:
    UltraFace(AAssetManager *mgr_, const std::string &mnn_path,
              int input_width, int input_length, int num_thread_ = 4, float score_threshold_ = 0.7, float iou_threshold_ = 0.2,
              int topk_ = -1);
...
private:
    ...
    void load_model(AAssetManager *mgr_, std::string mnn_path);
private:
